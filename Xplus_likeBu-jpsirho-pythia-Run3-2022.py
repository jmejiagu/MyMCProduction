...
xxfilter = cms.EDFilter("PythiaDauVFilter",
                        ...
                        DaughterIDs     = cms.untracked.vint32(443, 213),
                        MinPt           = cms.untracked.vdouble(6.0, 0.0), 
                        MinEta          = cms.untracked.vdouble(-4.0, -9999.0), 
                        MaxEta          = cms.untracked.vdouble( 4.0,  9999.0),
...
rhofilter = cms.EDFilter("PythiaDauVFilter",
                         ...
                         MinPt           = cms.untracked.vdouble(0.35, 0.2), 
                         MinEta          = cms.untracked.vdouble(-3.0, -9999.0), 
                         MaxEta          = cms.untracked.vdouble( 3.0,  9999.0),
                         verbose = cms.untracked.int32(0)
        )
...
ProductionFilterSequence = cms.Sequence(generator*xxfilter*rhofilter*jmmfilter)
