...
#Pythia fragment for filtered Chi_{b1,b2}(3P) -> Upsilon(mu+mu-) phi(k+k-) at 13.0TeV
...
pwaveMassfilter = cms.EDFilter("MCParticlePairFilter",
    ...
    MaxEta = cms.untracked.vdouble(1.6, 9.),
    MinEta = cms.untracked.vdouble(-1.6, -9.),
...
phi_from_ancestor = cms.EDFilter("PythiaFilterMultiAncestor",
    ...
    DaughterMaxPts = cms.untracked.vdouble(1000000.0, 1000000.0),
    DaughterMinEtas = cms.untracked.vdouble(-2.5, -2.5),
    DaughterMinPts = cms.untracked.vdouble(0.75, 0.75),
    MaxEta = cms.untracked.double(9.0),
    MinEta = cms.untracked.double(-9.0),
