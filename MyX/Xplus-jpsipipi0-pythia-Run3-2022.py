...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('evt_Xplus_2014.pdl'),
...
Particle   X_1(3872)+  3.8716400e+00   0.0000 ##  with X3872 width=0.00119?? X3872Id=9920443
...
"""
 ...
 #
            '10020443:new = X_1(3872)+ X_1(3872)- 3 3 0 3.8716400e+00 0.0000000e+00 3.87164 3.87164 0.0000000e+00',
            '10020443:isResonance = false',
            '10020443:addChannel = 1 1.0 0 443 211 111',
            '10020443:mayDecay = off',
...
#           'PTFilter:quarkPtMin = 2.0',  # Mínimo pT en GeV
...
xxfilter = cms.EDFilter("PythiaDauVFilter",
        ...
        ParticleID      = cms.untracked.int32(10020443),  
...
photonfilter = cms.EDFilter("PythiaDauVFilter",
            ...
            MotherID        = cms.untracked.int32(10020443),
