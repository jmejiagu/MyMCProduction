...
CHANNEL_DECAY="1-BcToJpsik"
step0_fragmentfile="bc1s-jpsik-pythia-Run3Summer22EEGS.py"
...
cmsDriver.py Configuration/GenProduction/python/$step0_fragmentfile --filein file:bcvegpy.lhe --filetype=LHE \
	     ...
	     --geometry DB:Extended --era Run3 --python_filename $step0_configfile --no_exec -n -1
