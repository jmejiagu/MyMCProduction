...
generator = cms.EDFilter("Pythia8HadronizerFilter",
                         ...
                         ExternalDecays = cms.PSet(
                           EvtGen130 = cms.untracked.PSet(
                             ...
                             #particle_property_file = cms.FileInPath('evt_Bc_2014.pdl'), ### CHECK ?!
                             convertPythiaCodes = cms.untracked.bool(False),
                             user_decay_embedded= cms.vstring(

'Particle B_c+      6.27447 0.00000e+00',
'Particle B_c*+     6.33207 0.00000e+00',
'Particle B_c(2S)+  6.75000 0.00000e+00 0.0000000e+00 3 2 0.0000000e+00',
'Particle B_c*(2S)+ 6.76800 0.00000e+00 0.0000000e+00 3 4 0.0000000e+00',
'Particle B_c-      6.27447 0.00000e+00',
'Particle B_c*-     6.33207 0.00000e+00',
'Particle B_c(2S)-  6.75000 0.00000e+00',
'Particle B_c*(2S)- 6.76800 0.00000e+00',
'Particle J/psi     3.09690 9.29000e-05',
'Particle psi(2S)   3.68610 2.94000e-04',
...
#
            '100541:new = B_c(2S)+ B_c(2S)- 3 3 0 6.75000e+00 0.0000000e+00 0.00000 0.00000 0.0000000e+00',
            '100541:isResonance = false',
            '100541:addChannel = 1 0.88 0 541 22',
            '100541:addChannel = 2 0.12 0 543 22',
            '100541:mayDecay = off',
#
            '100543:new = B_c*(2S)+ B_c*(2S)- 3 3 0 6.76800e+00 0.0000000e+00 0.00000 0.00000 0.0000000e+00',
